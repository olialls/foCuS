...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng Liverpool = new LatLng(53.4084, -2.9916);
        LatLng UK = new LatLng(51, -0.1);
        LatLng France = new LatLng(48, -2.4);

        mMap.addMarker(new MarkerOptions().position(Liverpool).title("James Kyle"));
        ...
        mMap.moveCamera(CameraUpdateFactory.newLatLng(Liverpool));
    }
}
